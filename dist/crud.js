...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rails_ujs__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__crud_modal_picker__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_crud_scss__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_crud_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__styles_crud_scss__);
...
(function ($) {
  var methods = {
    init: function (options) {
      ...
      var template = $("<div/>").addClass("modal-picker").append($("<div/>").addClass("input-group").append($("<span/>").addClass("input-group-addon").append($("<i/>").addClass(options.iconClass)), $("<div/>").addClass("form-control").append($("<span/>").addClass("picker-container").append($("<span/>").addClass("picker-clear").html("&times; "), $("<span/>").addClass("picker-placeholder").text(options.placeholder), $("<span/>").addClass("picker-value")))));
      ...
      return this.each(function () {
        ...
        function setPickerValue(selectedValue) {
          if ($.isArray(selectedValue)) {
            ...
            var labels = $.map(selectedValue, function (e) {
              return label(e);
            });
